...
export const Settings = () => {
    ...
    return (
        <SettingsContent>
            ...
            {initError && (
                <ErrorMessage data-test-id="@settings/init-error">
                    Init error: {initError}
                </ErrorMessage>
            )}
            {isInitSuccess && (
                <ConfirmationMessage data-test-id="@settings/init-success">
                    Init success!
                </ConfirmationMessage>
            )}
            {isHandshakeConfirmed && (
                <ConfirmationMessage data-test-id="@settings/handshake-confirmed">
                    Handshake confirmed!
                </ConfirmationMessage>
            )}
        </SettingsContent>

...
export const TransportBackends = () => {
    ...
    return (
        <>
            ...
            <SectionItem data-test-id="@settings/debug/processes/Bridge">
            ...
            <SectionItem data-test-id="@settings/debug/processes/bridgeLegacy">
                <TextColumn
            ...
            <SectionItem data-test-id="@settings/debug/processes/runOnStartUp">
            ...
            {!isDevEnv && (
                <SectionItem data-test-id="@settings/debug/processes/newBridgeRollout">
                    <TextColumn
